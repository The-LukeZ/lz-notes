...
<main class="mx-auto max-w-3xl px-4 py-10">
	...
	<p class="mt-1 text-xs uppercase tracking-wide text-gray-400">{meeting.meeting_type}</p>
	...
	{#if data.segments.length > 0}
		...
		<section class="mt-8">
			...
			{#if notes}
				...
				<pre
					class="mt-4 whitespace-pre-wrap rounded-lg border border-gray-200 bg-gray-50 p-4 text-sm">{notes}</pre>
			{/if}
		</section>
	{/if}
</main>
