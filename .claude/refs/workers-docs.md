...
- [Cloudflare Workers](https://developers.cloudflare.com/workers/index.md): Build and deploy serverless applications across Cloudflare's global network with Workers.

## Examples

- [Examples](https://developers.cloudflare.com/workers/examples/index.md): Browse code examples and starter templates for Cloudflare Workers.
...
- [Tutorials](https://developers.cloudflare.com/workers/tutorials/index.md): Step-by-step Workers tutorials and video guides to help you build projects on Cloudflare.
...
- [Build a Slackbot](https://developers.cloudflare.com/workers/tutorials/build-a-slackbot/index.md): Learn how to build a Slackbot with Hono and TypeScript in Cloudflare Workers
...
- [Demos and architectures](https://developers.cloudflare.com/workers/demos/index.md): Explore demo applications and reference architectures built with Cloudflare Workers.
- [Build an Interactive ChatGPT App](https://developers.cloudflare.com/workers/demos/chatgpt-app/index.md): Build and deploy an interactive ChatGPT App on Cloudflare Workers with real-time multiplayer state using MCP.

## Local development

- [Local development](https://developers.cloudflare.com/workers/local-development/index.md): Develop and test your Workers locally.
- [Supported bindings per development mode](https://developers.cloudflare.com/workers/local-development/bindings-per-env/index.md): Supported bindings per development mode
- [Environment variables and secrets](https://developers.cloudflare.com/workers/local-development/environment-variables/index.md): Configuring environment variables and secrets for local development
- [Adding local data](https://developers.cloudflare.com/workers/local-development/local-data/index.md): Populating local resources with data
- [Share a local dev server](https://developers.cloudflare.com/workers/local-development/local-dev-tunnels/index.md): Expose a local Wrangler or Vite dev server over a public tunnel URL.
- [Local Explorer](https://developers.cloudflare.com/workers/local-development/local-explorer/index.md): Browse and edit local binding data from your browser during development.
- [Developing with multiple Workers](https://developers.cloudflare.com/workers/local-development/multi-workers/index.md): Learn how to develop with multiple Workers using different approaches and configurations.
- [Vite Plugin](https://developers.cloudflare.com/workers/vite-plugin/index.md): Develop and build Cloudflare Workers projects using the Workers Vite plugin.
- [Choosing between Wrangler & Vite](https://developers.cloudflare.com/workers/local-development/wrangler-vs-vite/index.md): Choose between Wrangler and the Cloudflare Vite plugin for local development.

## Playground

- [Playground](https://developers.cloudflare.com/workers/playground/index.md): Preview and test Cloudflare Workers code in a browser-based sandbox without setup or authentication.

## Configuration

- [Configuration](https://developers.cloudflare.com/workers/configuration/index.md): Manage Cloudflare Workers project settings, bindings, and deployment options.
...
- [APIs](https://developers.cloudflare.com/workers/configuration/integrations/apis/index.md): Integrate Cloudflare Workers with third-party APIs using the Fetch API.
- [External Services](https://developers.cloudflare.com/workers/configuration/integrations/external-services/index.md): Connect Cloudflare Workers to external services using libraries, SDKs, and secure authentication.
- [Multipart upload metadata](https://developers.cloudflare.com/workers/configuration/multipart-upload-metadata/index.md): Define Workers configuration in JSON metadata for multipart form-data script uploads.
...
- [Custom Domains](https://developers.cloudflare.com/workers/configuration/routing/custom-domains/index.md): Connect a Cloudflare Worker to a domain or subdomain with automatic DNS and certificate management.
- [Routes](https://developers.cloudflare.com/workers/configuration/routing/routes/index.md): Map URL patterns to Cloudflare Workers to run your code on matching requests.
- [workers.dev](https://developers.cloudflare.com/workers/configuration/routing/workers-dev/index.md): Deploy Cloudflare Workers on a workers.dev subdomain for quick testing and personal projects.
...
- [Workers Sites configuration](https://developers.cloudflare.com/workers/configuration/sites/configuration/index.md): Configure Workers Sites settings for static asset hosting in your Wrangler configuration file.
- [Start from existing](https://developers.cloudflare.com/workers/configuration/sites/start-from-existing/index.md): Deploy an existing static site project to Cloudflare using Workers Sites.
- [Start from scratch](https://developers.cloudflare.com/workers/configuration/sites/start-from-scratch/index.md): Create a new Workers Sites project from scratch with Wrangler.
- [Start from Worker](https://developers.cloudflare.com/workers/configuration/sites/start-from-worker/index.md): Add static asset serving to an existing Cloudflare Worker using Workers Sites.
...
- [Versions & deployments](https://developers.cloudflare.com/workers/versions-and-deployments/index.md): Understand how Workers tracks changes with versions and releases them with deployments.
- [Deployment management](https://developers.cloudflare.com/workers/versions-and-deployments/deployment-management/index.md): Upload versions independently and control when and how they are deployed to your Worker's traffic.
- [Gradual deployments](https://developers.cloudflare.com/workers/versions-and-deployments/gradual-deployments/index.md): Incrementally deploy code changes to your Workers with gradual deployments.
- [Version affinity](https://developers.cloudflare.com/workers/versions-and-deployments/gradual-deployments/version-affinity/index.md): Consistently route users to the same Worker version during gradual deployments using version affinity.
- [With Durable Objects](https://developers.cloudflare.com/workers/versions-and-deployments/gradual-deployments/with-durable-objects/index.md): How gradual deployments work with Durable Objects, including version assignment, migrations, and guarantees.
- [Preview URLs](https://developers.cloudflare.com/workers/versions-and-deployments/preview-urls/index.md): Preview URLs allow you to preview new versions of your project without deploying it to production.
- [Rollbacks](https://developers.cloudflare.com/workers/versions-and-deployments/rollbacks/index.md): Revert to an older version of your Worker.
- [Version overrides](https://developers.cloudflare.com/workers/versions-and-deployments/version-overrides/index.md): Send requests to a specific version of your Worker in a gradual deployment using version overrides.

## Workers Cache

- [Workers Cache](https://developers.cloudflare.com/workers/cache/index.md): Workers Cache lets you cache Worker responses to reduce latency and Workers usage.
- [Cache keys](https://developers.cloudflare.com/workers/cache/cache-keys/index.md): How Workers Caching builds cache keys, with guidance for service bindings, multi-tenant Workers, and gradual deployments.
- [Configuration](https://developers.cloudflare.com/workers/cache/configuration/index.md): Enable and configure Workers Caching.
- [Debugging](https://developers.cloudflare.com/workers/cache/debugging/index.md): Diagnose why Workers Caching is not behaving the way you expect.
- [Examples](https://developers.cloudflare.com/workers/cache/examples/index.md): Patterns for combining Workers Caching with authentication, request normalization, and Durable Objects.
- [Limitations](https://developers.cloudflare.com/workers/cache/limitations/index.md): Current limitations, unsupported scenarios, and how Workers Caching relates to other Cloudflare caches.
- [Purging the cache](https://developers.cloudflare.com/workers/cache/purge/index.md): Invalidate cached responses using ctx.cache.purge() â€” purge by tag, by path prefix, or purge everything.
...
- [Event subscriptions](https://developers.cloudflare.com/workers/ci-cd/builds/event-subscriptions/index.md): Subscribe to Workers Builds events and send notifications to Slack, Discord, or webhook endpoints.
...
- [Runtime APIs](https://developers.cloudflare.com/workers/runtime-apis/index.md): Explore the JavaScript and web platform APIs available in the Cloudflare Workers runtime.
...
- [AI](https://developers.cloudflare.com/workers-ai/get-started/workers-wrangler/#2-connect-your-worker-to-workers-aiindex.md): Run generative AI inference and machine learning models on GPUs, without managing servers or infrastructure.
...
- [Assets](https://developers.cloudflare.com/workers/static-assets/binding/index.md): APIs available in Cloudflare Workers to interact with a collection of static assets. Static assets can be uploaded as part of your Worker.
- [Browser Run](https://developers.cloudflare.com/browser-run/index.md): Programmatically control and interact with a headless browser instance.
- [D1](https://developers.cloudflare.com/d1/worker-api/index.md): APIs available in Cloudflare Workers to interact with D1.  D1 is Cloudflare's native serverless database.
- [Dispatcher (Workers for Platforms)](https://developers.cloudflare.com/cloudflare-for-platforms/workers-for-platforms/configuration/dynamic-dispatch/index.md): Let your customers deploy their own code to your platform, and dynamically dispatch requests from your Worker to their Worker.
- [Durable Objects](https://developers.cloudflare.com/durable-objects/api/index.md): A globally distributed coordination API with strongly consistent storage.
- [Environment Variables](https://developers.cloudflare.com/workers/configuration/environment-variables/index.md): Add string and JSON values to your Worker.
...
- [Images](https://developers.cloudflare.com/images/optimization/binding/index.md): Store, transform, optimize, and deliver images at scale.
- [KV](https://developers.cloudflare.com/kv/api/index.md): Global, low-latency, key-value data storage.
- [Media Transformations](https://developers.cloudflare.com/stream/transform-videos/bindings/index.md): Optimize, transform, and extract from short-form video.
...
- [Queues](https://developers.cloudflare.com/queues/configuration/javascript-apis/index.md): Send and receive messages with guaranteed delivery.
- [R2](https://developers.cloudflare.com/r2/api/workers/workers-api-reference/index.md): APIs available in Cloudflare Workers to read from and write to R2 buckets.  R2 is S3-compatible, zero egress-fee, globally distributed object storage.
...
- [Secrets](https://developers.cloudflare.com/workers/configuration/secrets/index.md): Add encrypted secrets to your Worker.
- [Secrets Store](https://developers.cloudflare.com/secrets-store/integrations/workers/index.md): Account-level secrets that can be added to Workers applications as a binding.
...
- [Stream](https://developers.cloudflare.com/stream/manage-video-library/bindings/index.md): Upload, manage, and deliver video with Cloudflare Stream.
- [Vectorize](https://developers.cloudflare.com/vectorize/reference/client-api/index.md): APIs available in Cloudflare Workers to interact with Vectorize.  Vectorize is Cloudflare's globally distributed vector database.
...
- [Workflows](https://developers.cloudflare.com/workflows/index.md): APIs available in Cloudflare Workers to interact with Workflows. Workflows allow you to build durable, multi-step applications using Workers.
...
- [Alarm Handler](https://developers.cloudflare.com/durable-objects/api/alarms/index.md): Handle scheduled alarms in Cloudflare Workers using the Durable Objects alarm API.
- [Email Handler](https://developers.cloudflare.com/email-service/api/route-emails/email-handler/index.md): Process incoming emails in Cloudflare Workers using the Email Routing runtime API.
- [Fetch Handler](https://developers.cloudflare.com/workers/runtime-apis/handlers/fetch/index.md): Handle incoming HTTP requests in Cloudflare Workers using the fetch() handler and return responses.
- [Queue Handler](https://developers.cloudflare.com/queues/configuration/javascript-apis/#consumerindex.md): Consume messages from Cloudflare Queues using the queue handler in Workers.
- [Scheduled Handler](https://developers.cloudflare.com/workers/runtime-apis/handlers/scheduled/index.md): Run Workers on a recurring schedule using the scheduled() handler and Cron Triggers.
- [Tail Handler](https://developers.cloudflare.com/workers/runtime-apis/handlers/tail/index.md): Process real-time logs from producer Workers using the tail() handler in Tail Workers.
...
- [assert](https://developers.cloudflare.com/workers/runtime-apis/nodejs/assert/index.md): Use the Node.js assert module in Cloudflare Workers for testing assertions and value comparisons.
- [AsyncLocalStorage](https://developers.cloudflare.com/workers/runtime-apis/nodejs/asynclocalstorage/index.md): Use the Node.js AsyncLocalStorage API in Cloudflare Workers to maintain context across asynchronous operations.
- [Buffer](https://developers.cloudflare.com/workers/runtime-apis/nodejs/buffer/index.md): Use the Node.js Buffer API in Cloudflare Workers to manipulate binary data with encoding and decoding support.
- [crypto](https://developers.cloudflare.com/workers/runtime-apis/nodejs/crypto/index.md): Use the Node.js crypto module in Cloudflare Workers for hashing, encryption, signing, and verification.
- [Diagnostics Channel](https://developers.cloudflare.com/workers/runtime-apis/nodejs/diagnostics-channel/index.md): Use the Node.js diagnostics_channel API in Cloudflare Workers for low-overhead diagnostic event reporting.
- [dns](https://developers.cloudflare.com/workers/runtime-apis/nodejs/dns/index.md): Use the Node.js dns module in Cloudflare Workers for DNS name resolution via DNS over HTTPS.
- [EventEmitter](https://developers.cloudflare.com/workers/runtime-apis/nodejs/eventemitter/index.md): Use the Node.js EventEmitter API in Cloudflare Workers to emit and listen for named events.
- [fs](https://developers.cloudflare.com/workers/runtime-apis/nodejs/fs/index.md): Use the Node.js fs module in Cloudflare Workers to access a virtual file system for reading and writing files.
- [http](https://developers.cloudflare.com/workers/runtime-apis/nodejs/http/index.md): Use the Node.js http module in Cloudflare Workers for client and server-side HTTP functionality.
- [https](https://developers.cloudflare.com/workers/runtime-apis/nodejs/https/index.md): Use the Node.js https module in Cloudflare Workers for TLS-encrypted HTTP client and server functionality.
- [net](https://developers.cloudflare.com/workers/runtime-apis/nodejs/net/index.md): Use the Node.js net module in Cloudflare Workers to create TCP socket connections to external servers.
- [path](https://developers.cloudflare.com/workers/runtime-apis/nodejs/path/index.md): Use the Node.js path module in Cloudflare Workers for file and directory path manipulation utilities.
- [process](https://developers.cloudflare.com/workers/runtime-apis/nodejs/process/index.md): Use the Node.js process module in Cloudflare Workers for environment variables, event handling, and runtime information.
- [Streams](https://developers.cloudflare.com/workers/runtime-apis/nodejs/streams/index.md): Use the Node.js streams API in Cloudflare Workers for readable, writable, and transform stream operations.
- [StringDecoder](https://developers.cloudflare.com/workers/runtime-apis/nodejs/string-decoder/index.md): Use the Node.js string_decoder module in Cloudflare Workers for decoding buffer objects into strings.
- [test](https://developers.cloudflare.com/workers/runtime-apis/nodejs/test/index.md): Use the Node.js test module MockTracker API in Cloudflare Workers for tracking and managing mock objects.
- [timers](https://developers.cloudflare.com/workers/runtime-apis/nodejs/timers/index.md): Use the Node.js timers API in Cloudflare Workers to schedule functions with setTimeout, setInterval, and setImmediate.
- [tls](https://developers.cloudflare.com/workers/runtime-apis/nodejs/tls/index.md): Use the Node.js tls module in Cloudflare Workers to create secure TLS connections to external services.
- [url](https://developers.cloudflare.com/workers/runtime-apis/nodejs/url/index.md): Use the Node.js url module in Workers for domain-to-ASCII and domain-to-Unicode conversions.
- [util](https://developers.cloudflare.com/workers/runtime-apis/nodejs/util/index.md): Use the Node.js util module in Workers for promisify, callbackify, types, and MIMEType support.
- [zlib](https://developers.cloudflare.com/workers/runtime-apis/nodejs/zlib/index.md): Use the Node.js zlib module in Workers for Gzip, Deflate, and Brotli compression.
...
- [ReadableStream](https://developers.cloudflare.com/workers/runtime-apis/streams/readablestream/index.md): Learn about the ReadableStream API for reading streamed data in Cloudflare Workers.
- [ReadableStream BYOBReader](https://developers.cloudflare.com/workers/runtime-apis/streams/readablestreambyobreader/index.md): Use ReadableStreamBYOBReader in Workers to read streamed data into your own buffer.
- [ReadableStream DefaultReader](https://developers.cloudflare.com/workers/runtime-apis/streams/readablestreamdefaultreader/index.md): Use ReadableStreamDefaultReader in Workers to read chunks from a ReadableStream.
- [TransformStream](https://developers.cloudflare.com/workers/runtime-apis/streams/transformstream/index.md): Use the TransformStream API in Workers to pipe data between readable and writable streams.
- [WritableStream](https://developers.cloudflare.com/workers/runtime-apis/streams/writablestream/index.md): Use the WritableStream API in Workers to write data to a stream destination.
- [WritableStream DefaultWriter](https://developers.cloudflare.com/workers/runtime-apis/streams/writablestreamdefaultwriter/index.md): Use WritableStreamDefaultWriter in Workers to write data directly to a WritableStream.
...
- [Wasm in JavaScript](https://developers.cloudflare.com/workers/runtime-apis/webassembly/javascript/index.md): Import and instantiate WebAssembly modules in Cloudflare Workers using JavaScript.
...
- [Headers](https://developers.cloudflare.com/workers/static-assets/headers/index.md): Learn about default and custom headers for Workers static assets, including Cache-Control, ETag, and Content-Type behavior.
...
- [Redirects](https://developers.cloudflare.com/workers/static-assets/redirects/index.md): Configure redirect rules for Workers static assets using a _redirects file.
- [Gradual rollouts](https://developers.cloudflare.com/workers/versions-and-deployments/gradual-deployments/version-affinity/#static-assetsindex.md): Prevent asset mismatches during gradual Worker deployments with static assets.
...
- [DevTools](https://developers.cloudflare.com/workers/observability/dev-tools/index.md): Use Chrome DevTools to debug, profile, and inspect Cloudflare Workers locally.
...
- [Profiling Memory](https://developers.cloudflare.com/workers/observability/dev-tools/memory-usage/index.md): Profile memory usage with DevTools snapshots to optimize Workers and avoid OOM errors.
...
- [Exporting OpenTelemetry Data](https://developers.cloudflare.com/workers/observability/exporting-opentelemetry-data/index.md): Export traces and logs from Cloudflare Workers to any OpenTelemetry-compatible destination.
- [Export to Axiom](https://developers.cloudflare.com/workers/observability/exporting-opentelemetry-data/axiom/index.md): Send OpenTelemetry traces and logs from Cloudflare Workers to Axiom.
- [Export to Grafana Cloud](https://developers.cloudflare.com/workers/observability/exporting-opentelemetry-data/grafana-cloud/index.md): Send OpenTelemetry traces and logs from Cloudflare Workers to Grafana Cloud.
- [Export to Honeycomb](https://developers.cloudflare.com/workers/observability/exporting-opentelemetry-data/honeycomb/index.md): Send OpenTelemetry traces and logs from Cloudflare Workers to Honeycomb.
- [Export to PostHog](https://developers.cloudflare.com/workers/observability/exporting-opentelemetry-data/posthog/index.md): Send OpenTelemetry logs from Cloudflare Workers to PostHog for analytics.
- [Export to Sentry](https://developers.cloudflare.com/workers/observability/exporting-opentelemetry-data/sentry/index.md): Export OpenTelemetry traces and logs from Cloudflare Workers to Sentry for monitoring and debugging.
- [Logs](https://developers.cloudflare.com/workers/observability/logs/index.md): Access, filter, and export logs from Cloudflare Workers for troubleshooting.
...
- [Traces](https://developers.cloudflare.com/workers/observability/traces/index.md): Gain end-to-end visibility into request flows across your Workers application with automatic tracing instrumentation.
- [Custom spans](https://developers.cloudflare.com/workers/observability/traces/custom-spans/index.md): Create custom spans to trace your own application logic alongside Cloudflare's automatic instrumentation.
- [Known limitations](https://developers.cloudflare.com/workers/observability/traces/known-limitations/index.md)
- [Spans and attributes](https://developers.cloudflare.com/workers/observability/traces/spans-and-attributes/index.md): Review the spans and attributes automatically captured by Workers tracing, including fetch calls, bindings, and handler invocations.

## Testing

- [Testing](https://developers.cloudflare.com/workers/testing/index.md): Choose testing tools for Cloudflare Workers, including createTestHarness and the Vitest integration.
- [Miniflare](https://developers.cloudflare.com/workers/testing/miniflare/index.md): Simulate and test Cloudflare Workers locally with Miniflare, a fully-local development simulator.
- [Compatibility Dates](https://developers.cloudflare.com/workers/testing/miniflare/core/compatibility/index.md): Configure compatibility dates and flags in Miniflare to match Cloudflare Workers runtime behavior.
- [Fetch Events](https://developers.cloudflare.com/workers/testing/miniflare/core/fetch/index.md): Dispatch and test HTTP fetch events in Miniflare for Cloudflare Workers.
...
- [Attaching a Debugger](https://developers.cloudflare.com/workers/testing/miniflare/developing/debugger/index.md): Attach a Node.js debugger to Miniflare for setting breakpoints and inspecting Cloudflare Workers code.
- [Live Reload](https://developers.cloudflare.com/workers/testing/miniflare/developing/live-reload/index.md): Enable automatic browser refresh in Miniflare when your Workers script changes during local development.
- [Get Started](https://developers.cloudflare.com/workers/testing/miniflare/get-started/index.md): Install and configure the Miniflare API to dispatch events and test Cloudflare Workers locally.
- [Migrating from Version 2](https://developers.cloudflare.com/workers/testing/miniflare/migrations/from-v2/index.md): Migrate from Miniflare v2 to v3, which uses the workerd runtime for full Workers compatibility.
...
- [Integration test harness](https://developers.cloudflare.com/workers/testing/test-harness/index.md): Write integration tests for Cloudflare Workers with the createTestHarness API in Wrangler.
- [Configure the test harness](https://developers.cloudflare.com/workers/testing/test-harness/configure/index.md): Configure Workers, test values, and lifecycle options for createTestHarness.
- [Get started](https://developers.cloudflare.com/workers/testing/test-harness/get-started/index.md): Write your first integration test for a Cloudflare Worker with createTestHarness.
- [Integrations](https://developers.cloudflare.com/workers/testing/test-harness/integrations/index.md): Use createTestHarness with Mock Service Worker and Playwright.
- [Interact with Workers](https://developers.cloudflare.com/workers/testing/test-harness/interact-with-workers/index.md): Test routes, dispatch events, control Workflows, and assert logged behavior with createTestHarness.
- [Prepare test state](https://developers.cloudflare.com/workers/testing/test-harness/prepare-test-state/index.md): Seed local storage and replace dependencies in createTestHarness tests.
...
- [Vitest integration](https://developers.cloudflare.com/workers/testing/vitest-integration/index.md): Run unit and integration tests for Cloudflare Workers inside the Workers runtime using the Vitest integration.
...
- [Migrate from unstable_dev](https://developers.cloudflare.com/workers/testing/vitest-integration/migration-guides/migrate-from-unstable-dev/index.md): Migrate from the unstable_dev API to writing tests with the Workers Vitest integration.
- [Migrate from Vitest 3 to Vitest 4](https://developers.cloudflare.com/workers/testing/vitest-integration/migration-guides/migrate-from-vitest-3-to-vitest-4/index.md): Migrate the Workers Vitest integration from v0.12.x (Vitest 3) to v0.13.x (Vitest 4), covering configuration and test file changes.
...
- [JavaScript](https://developers.cloudflare.com/workers/languages/javascript/index.md): Write Cloudflare Workers using JavaScript standards and web platform APIs.
- [Examples](https://developers.cloudflare.com/workers/examples/?languages=JavaScriptindex.md): Browse JavaScript code examples for Cloudflare Workers.
...
- [Examples](https://developers.cloudflare.com/workers/languages/python/examples/index.md): Python code examples demonstrating modules, bindings, and SDK usage in Workers.
- [Foreign Function Interface (FFI)](https://developers.cloudflare.com/workers/languages/python/ffi/index.md): Call JavaScript APIs, bindings, and globals from Python Workers using the Pyodide FFI.
- [How Python Workers Work](https://developers.cloudflare.com/workers/languages/python/how-python-workers-work/index.md): Learn how Python Workers run via Pyodide in V8 isolates and how local development works.
- [Packages](https://developers.cloudflare.com/workers/languages/python/packages/index.md): Manage and use Python packages in Cloudflare Workers with Pywrangler.
- [FastAPI](https://developers.cloudflare.com/workers/languages/python/packages/fastapi/index.md): Build Python Workers APIs using FastAPI with the built-in ASGI server.
- [Langchain](https://developers.cloudflare.com/workers/languages/python/packages/langchain/index.md): Use LangChain Python packages to build AI applications on Cloudflare Workers.
- [Standard Library](https://developers.cloudflare.com/workers/languages/python/stdlib/index.md): Python standard library availability and limitations in Cloudflare Workers.
...
- [Supported crates](https://developers.cloudflare.com/workers/languages/rust/crates/index.md): Popular Rust crates confirmed to compile to WebAssembly and run on Cloudflare Workers.
- [TypeScript](https://developers.cloudflare.com/workers/languages/typescript/index.md): Use TypeScript with fully typed APIs to build Cloudflare Workers.
- [Examples](https://developers.cloudflare.com/workers/examples/?languages=TypeScriptindex.md): Browse TypeScript code examples for Cloudflare Workers.

## Glossary

- [Glossary](https://developers.cloudflare.com/workers/glossary/index.md): Definitions of terms used in the Cloudflare Workers documentation.
...
- [Analytics Engine](https://developers.cloudflare.com/analytics/analytics-engine/index.md): Use Workers to receive performance analytics about your applications, products and projects.
...
- [Cloudflare D1](https://developers.cloudflare.com/d1/index.md): Cloudflareâ€™s native serverless database.
- [Hyperdrive](https://developers.cloudflare.com/hyperdrive/index.md): Use Workers to accelerate queries you make to existing databases.
...
- [PlanetScale](https://developers.cloudflare.com/workers/databases/third-party-integrations/planetscale/index.md): Connect Cloudflare Workers to a PlanetScale MySQL-compatible database using Hyperdrive or the PlanetScale serverless driver.
- [Supabase](https://developers.cloudflare.com/workers/databases/third-party-integrations/supabase/index.md): Connect Cloudflare Workers to a Supabase PostgreSQL database using the Supabase client or Hyperdrive.
- [Turso](https://developers.cloudflare.com/workers/databases/third-party-integrations/turso/index.md): Connect Cloudflare Workers to Turso, an edge-hosted distributed database based on libSQL.
- [Upstash](https://developers.cloudflare.com/workers/databases/third-party-integrations/upstash/index.md): Connect Cloudflare Workers to Upstash for serverless Redis and Kafka integrations.
- [Xata](https://developers.cloudflare.com/workers/databases/third-party-integrations/xata/index.md): Connect Cloudflare Workers to a Xata PostgreSQL database using Hyperdrive.
- [Vectorize (vector database)](https://developers.cloudflare.com/vectorize/index.md): A globally distributed vector database that enables you to build full-stack, AI-powered applications with Cloudflare Workers.

## framework-guides

- [Agents SDK](https://developers.cloudflare.com/agents/index.md): Build AI agents on Cloudflare Workers using the Agents SDK.
- [LangChain](https://developers.cloudflare.com/workers/languages/python/packages/langchain/index.md): Build AI-powered applications on Cloudflare Workers using LangChain.
- [FastAPI](https://developers.cloudflare.com/workers/languages/python/packages/fastapi/index.md): Deploy FastAPI applications on Cloudflare Workers with Python support.
- [Hono](https://developers.cloudflare.com/workers/framework-guides/web-apps/more-web-frameworks/hono/index.md): Build lightweight web APIs on Cloudflare Workers using the Hono framework.
...
- [More guides...](https://developers.cloudflare.com/workers/framework-guides/web-apps/more-web-frameworks/index.md): Additional framework guides for building web applications on Cloudflare Workers.
...
- [Dashboard](https://developers.cloudflare.com/workers/get-started/dashboard/index.md): Create and deploy a Cloudflare Worker using the Cloudflare dashboard.
- [CLI](https://developers.cloudflare.com/workers/get-started/guide/index.md): Set up and deploy your first Cloudflare Worker using Wrangler, the command-line interface.
...
- [Claim deployments (temporary accounts)](https://developers.cloudflare.com/workers/platform/claim-deployments/index.md): Deploy Workers before authentication, then claim the temporary account to keep its deployments and resources.
...
- [Infrastructure as Code (IaC)](https://developers.cloudflare.com/workers/platform/infrastructure-as-code/index.md): Deploy and manage Cloudflare Workers using Terraform, Pulumi, and the Cloudflare API SDKs.
...
- [Workers for Platforms](https://developers.cloudflare.com/cloudflare-for-platforms/workers-for-platforms/index.md): Deploy custom code on behalf of your users or let your users directly deploy their own code to your platform, managing infrastructure.
...
- [Security model](https://developers.cloudflare.com/workers/reference/security-model/index.md): Understand the Workers security architecture, including V8 isolate sandboxing and Spectre mitigations.
...
- [Artifacts](https://developers.cloudflare.com/workers/wrangler/commands/artifacts/index.md): Manage Artifacts namespaces, repositories, and repo-scoped tokens using Wrangler.
- [Browser](https://developers.cloudflare.com/workers/wrangler/commands/browser/index.md): Wrangler commands for interacting with Cloudflare Browser Run.
...
- [Flagship](https://developers.cloudflare.com/workers/wrangler/commands/flagship/index.md): Wrangler commands for managing Flagship apps, feature flags, targeting rules, rollouts, evaluations, and changelog history.
- [General commands](https://developers.cloudflare.com/workers/wrangler/commands/general/index.md): General Wrangler commands for authentication, telemetry, and shell completions.
...
- [Workers](https://developers.cloudflare.com/workers/wrangler/commands/workers/index.md): Wrangler commands for creating, developing, deploying, and managing Workers.
...
- [Migrate from Wrangler v2 to v3](https://developers.cloudflare.com/workers/wrangler/migration/update-v2-to-v3/index.md): Update Wrangler from v2 to v3 with no special migration steps required. Review deprecations and known issues.
- [Migrate from Wrangler v3 to v4](https://developers.cloudflare.com/workers/wrangler/migration/update-v3-to-v4/index.md): Upgrade Wrangler from v3 to v4, including breaking changes, updated Node.js requirements, and new defaults.
- [1. Migrate webpack projects](https://developers.cloudflare.com/workers/wrangler/migration/v1-to-v2/eject-webpack/index.md): Migrate webpack-based Workers projects from Wrangler v1 to v2 by ejecting your bundler configuration.
- [2. Update to Wrangler v2](https://developers.cloudflare.com/workers/wrangler/migration/v1-to-v2/update-v1-to-v2/index.md): Install Wrangler v2 and update your Workers project configuration, including wrangler.toml changes.
- [Authentication](https://developers.cloudflare.com/workers/wrangler/migration/v1-to-v2/wrangler-legacy/authentication/index.md): Set up authentication for Wrangler v1 using API tokens, environment variables, or the login command.
- [Commands](https://developers.cloudflare.com/workers/wrangler/migration/v1-to-v2/wrangler-legacy/commands/index.md): Reference for all Wrangler v1 CLI commands, including generate, publish, and preview. Now deprecated.
...
- [Install / Update](https://developers.cloudflare.com/workers/wrangler/migration/v1-to-v2/wrangler-legacy/install-update/index.md): Install or update Wrangler v1 using npm or Cargo. Now deprecated in favor of the latest Wrangler release.
...
- [Authentication profiles](https://developers.cloudflare.com/workers/wrangler/profiles/index.md): Maintain separate logins and switch accounts per directory.
